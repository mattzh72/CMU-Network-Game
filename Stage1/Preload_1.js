...
Game.Preload_1.prototype = {
    ...
    this.load.image('tileset1','Stage1/Map/pipe_opening.png');
    this.load.image('tileset2','Stage1/Map/Rooms/blue_room.png');
    this.load.image('tileset3','Stage1/Map/Rooms/yellow_room.png');
