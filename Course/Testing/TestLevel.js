...
Game.TestLevel.prototype = {
    ...
    create: function() {
        ...
        let IPS;
        IPS = addSprite(["Intrusion Detection"], ["I act as an IPS, or intrusion detection system, a device or program that observes a network for any malicious activities or policy violations, during which I produce reports about the network security.  Intrusion detection systems are passive systems.", "Press C to Close"], 'robot', 500, 500, 0.3, 0, true, this);
