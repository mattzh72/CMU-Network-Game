...
Game.Stage_0.prototype = {
    ...
    create: function () {
        ...
        let IPS = addSprite('IPS Worker',['I work in the IPS Room!'], 'robot', this.game.world.centerX + 220, 1450, 0.2, 0, true, this);
        let proxy = addSprite('Proxy Worker',['I work in the proxy Room!'], 'proxy', this.game.world.centerX - 220, 1450, 0.2, 0, true, this);
        
        
        //init pipes
        this.packetStream1 = initPacketStream(this.game.world.centerX - 400, 1750, this.game.world.centerX + 400, 1750, false, this);
